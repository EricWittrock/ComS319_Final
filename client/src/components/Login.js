        ...
        <section className="vh-100 gradient-custom">
            <div className="container py-5 h-100">
                ...
                <div className="col-12 col-md-8 col-lg-6 col-xl-5">
                    ...
                    <svg style={{padding:"5px", position:"absolute", right:"0px"}} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-x-circle" viewBox="0 0 16 16">
